        ...
        <ul class="menu-inner py-7">
          ...
          <div data-i18n="Dashboards">Dashboards</div>
            ...
            <template v-if="menuGroupsStore.menuGroups && menuGroupsStore.menuGroups.length">
              <li
          class="menu-item"
          :class="{ open: group.menuDetails && group.menuDetails.some(detail => detail.route === $route.path), active: group.menuDetails && group.menuDetails.some(detail => detail.route === $route.path) }"
          v-for="group in menuGroupsStore.menuGroups"
          :key="group.id"
              >
          ...
          <ul class="menu-sub" v-if="group.menuDetails && group.menuDetails.length">
            <li
              class="menu-item"
              v-for="detail in group.menuDetails"
              :key="detail.id"
